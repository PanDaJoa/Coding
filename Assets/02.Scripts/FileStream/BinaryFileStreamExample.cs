...
public class BinaryFileStreamExample : MonoBehaviour
{
    void Start()
    {
        ...
        // .dat: 데이터(date)의 약어로 사용자가 정의한 데이터가 들어있는 파일의 확장자

        // <파일 쓰기>
        // 바이너리 파일을 쓸때는 "BinarymWriter" 클래스 사용
        ...
        // BinarymWriter를 사용하면 메모리를 좀 더 효율적으로 사용하고, 속도도 더 빠르다.

        // <파일 읽기>
        // 바이너리 파일을 읽을때는 "BinrayReader" 클래스 사용
