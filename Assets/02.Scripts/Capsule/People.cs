...
public class People
{
    ...
    // 먼저 속성을 은닉화 하고 행위를 통해 속성을 접근/수정하게 하게 함으로서
    // 잘못 된 접근이나 의도치 않는 값으로 변하는 보호 효과를 누린다.
